    ...
    <>
      ...
      <main className="container" style={{ minHeight: "70vh", paddingTop: "clamp(1rem, 2vw, 1.5rem)", paddingBottom: "clamp(1rem, 2vw, 1.25rem)" }}>
        <div className="card" style={{ maxWidth: "780px", margin: "0 auto", padding: "clamp(2rem, 5vw, 3rem)" }}>
          ...
          <div style={{ overflowX: "auto", marginTop: "1rem", borderRadius: 8, border: "1px solid #DCE1E3" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  {["Name", "Type", "Purpose", "Duration"].map(h => (
                    <th key={h} style={{ ...TABLE_CELL, color: "#0D0F10", fontWeight: 700, textAlign: "left", fontSize: "0.6875rem", letterSpacing: "0.08em", textTransform: "uppercase" }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
