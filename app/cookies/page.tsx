    ...
    <>
      ...
      <main className="container" style={{ minHeight: "70vh", paddingTop: "clamp(1rem, 2vw, 1.5rem)", paddingBottom: "clamp(1rem, 2vw, 1.25rem)" }}>
        <div className="block" style={{ maxWidth: "780px", margin: "0 auto", padding: "clamp(2rem, 5vw, 3rem)" }}>
          ...
          <div style={{ overflowX: "auto", marginTop: "1rem", borderRadius: 4, border: "1px solid #E5E5E5" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr>
                  {["Name", "Type", "Purpose", "Duration"].map(h => (
                    <th key={h} style={{ ...TABLE_CELL, color: "#000000", fontWeight: 700, textAlign: "left", fontSize: "0.6875rem", letterSpacing: "0.08em", textTransform: "uppercase" }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
