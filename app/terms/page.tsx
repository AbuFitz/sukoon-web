    ...
    <>
      ...
      <main className="container" style={{ minHeight: "70vh", paddingTop: "clamp(1rem, 2vw, 1.5rem)", paddingBottom: "clamp(1rem, 2vw, 1.25rem)" }}>
        <div className="card" style={{ maxWidth: "780px", margin: "0 auto", padding: "clamp(2rem, 5vw, 3rem)" }}>
          ...
          <p style={PROSE}>We aim to dispatch all orders within 2–3 working days. Delivery times are estimates and not guaranteed. Risk passes to you on delivery. See our <a href="/shipping" style={{ color: "#0D0F10", textUnderlineOffset: "3px" }}>Shipping &amp; Returns</a> page for full details.</p>
