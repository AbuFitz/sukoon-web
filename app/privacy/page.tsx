    ...
    <>
      ...
      <main style={{ paddingTop: "calc(1.75rem + 84px)", backgroundColor: "#faf8f3", minHeight: "80vh" }}>
        <div style={{ maxWidth: "780px", margin: "0 auto", padding: "clamp(3rem, 7vw, 5rem) clamp(1.5rem, 5vw, 3rem)" }}>
          ...
          <p style={PROSE}>We use a small number of cookies to make the site work (session cookies) and, with your consent, analytics cookies to understand how the site is used. See our <a href="/cookies" style={{ color: "#292b25", textUnderlineOffset: "3px" }}>Cookie Policy</a> for full details.</p>
