  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1320px", margin: "0 auto" }}>
        <p style={{ fontFamily: "var(--font-body)", fontSize: "0.5625rem", fontWeight: 500, letterSpacing: "0.22em", textTransform: "uppercase", color: "#98A47D", marginBottom: "2rem" }}>
        ...
        <div className="hidden md:grid" style={{
          ...
          <div style={{ gridRow: "1 / 3", position: "relative", overflow: "hidden", backgroundColor: "#E8D4AE" }}>
          ...
          <div style={{ position: "relative", overflow: "hidden", backgroundColor: "#E8D4AE" }}>
          ...
          <div style={{ gridRow: "1 / 3", gridColumn: "3", position: "relative", overflow: "hidden", backgroundColor: "#E8D4AE" }}>
        ...
        <div className="grid grid-cols-2 md:hidden" style={{ gap: "0.5rem" }}>
          {[
            ...
            <div key={img.src} style={{ position: "relative", height: "200px", overflow: "hidden", backgroundColor: "#E8D4AE" }}>
