...
const sections = [
  {
    heading: "The Product",
    items: [
      { q: "What exactly is The Daily Solace Fluid?", a: "A 100% waterless oil nectar — 30ml of four active ingredients, nothing else. It works on two areas most products ignore: your face and your hairline. No water, no fragrance, no filler oils." },
      { q: "What ingredients are in the formula?", a: "Olive Squalane (80%), Niacinamide / Vitamin B3 (14.9%), Black Seed Oil (2%), and Vitamin E (3%). That's the entire formula. Every percentage is there for a reason." },
