  ...
  return (
    <section className="container" style={{ paddingTop: "clamp(1rem, 2vw, 1.25rem)" }}>
      <div className="card story-grid" style={{
        ...
        {/* Image */}
        <div style={{ position: "relative", backgroundColor: "#F4F4F2", minHeight: 320 }}>
          <Image
        ...
        <div style={{
          ...
          <p style={{
            ...
            color: "#666666", margin: "0 0 0.875rem", maxWidth: 440,
          }}>
          ...
          <p style={{
            fontFamily: "var(--font-body)", fontSize: "0.9375rem", lineHeight: 1.65,
            color: "#666666", margin: "0 0 1.5rem", maxWidth: 440,
          }}>
