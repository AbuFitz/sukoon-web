        ...
        {variantId ? (
          ...
          <a
            ...
            style={{
              ...
              letterSpacing: "0.06em", textTransform: "uppercase",
              color: "#3F4A36",
              border: "1px solid rgba(63,76,56,0.35)",
              padding: "0.8125rem",
...
export function FeaturedProductsSection({ products }: { products: FeaturedProduct[] }) {
  return (
    <section style={{ backgroundColor: "#faf8f3", padding: "88px 0 108px" }}>
      <div style={{
        ...
        <div style={{
          ...
          marginBottom: 52, flexWrap: "wrap", gap: "1.5rem",
        }}>
          <div>
            <p style={{
        ...
        {/* Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3" style={{ gap: 30 }}>
