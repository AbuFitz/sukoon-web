...
const fieldStyle: React.CSSProperties = {
  ...
  border: `1px solid ${LINE}`, outline: "none", backgroundColor: "#FBF8F3",
};

export function AccountPanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <Panel open={open} onClose={onClose} title="Account">
      <p style={{ fontFamily: "var(--font-body)", fontSize: "0.875rem", color: SAGE, lineHeight: 1.6, marginBottom: "1.75rem" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.875rem", margin: "1.75rem 0" }}>
        ...
        <span style={{ fontFamily: "var(--font-body)", fontSize: "0.6875rem", letterSpacing: "0.06em", color: SAGE, textTransform: "uppercase" }}>New here</span>
        <span style={{ flex: 1, height: "1px", backgroundColor: LINE }} />
      </div>
      ...
      <p style={{ fontFamily: "var(--font-body)", fontSize: "0.75rem", color: SAGE, marginTop: "2rem", lineHeight: 1.6 }}>
