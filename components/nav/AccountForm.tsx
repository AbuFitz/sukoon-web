...
const fieldStyle: React.CSSProperties = {
  ...
  border: `1px solid ${LINE}`, borderRadius: 999, outline: "none", backgroundColor: "#F9F8F6",
};

export function AccountForm() {
  return (
    <>
      <p style={{ fontFamily: "var(--font-body)", fontSize: "0.875rem", color: "#666666", lineHeight: 1.6, marginBottom: "1.75rem" }}>
      ...
      <form onSubmit={(e) => e.preventDefault()} style={{ display: "flex", flexDirection: "column", gap: "0.875rem" }}>
        ...
        <button type="submit" className="btn btn-dark" style={{ marginTop: "0.375rem" }}>
          Sign In
        </button>
      </form>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.875rem", margin: "1.75rem 0" }}>
        ...
        <span style={{ fontFamily: "var(--font-body)", fontSize: "0.75rem", fontWeight: 600, color: MUTED }}>New here</span>
        <span style={{ flex: 1, height: "1px", backgroundColor: LINE }} />
      </div>
